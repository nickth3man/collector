...
class TestYouTubeScraper:
    ...
    def test_detect_video_url(self, scraper):
        ...
        assert scraper._is_playlist_or_channel("https://www.youtube.com/watch?v=dQw4w9WgXcQ") is False
    ...
    def test_detect_playlist_url(self, scraper):
        ...
        assert scraper._is_playlist_or_channel("https://www.youtube.com/playlist?list=PLrAXtmErZgOeiKm4sgNOknGvNjby9efdf") is True
