...
class TestJobService:
    ...
    @patch("services.job_service.JobRepository")
    @patch("services.job_service.FileRepository")
    ...
    @patch("services.job_service.JobService.get_job")
    @patch("services.job_service.JobService.create_job")
    def test_prepare_retry_job_success(self, mock_create, mock_get):
        ...
        mock_get.return_value = mock_original_job
        ...
        mock_get.assert_called_once_with("job123")
        mock_create.assert_called_once_with(
            url="https://example.com", platform="youtube", title="Test Video"
        )

    @patch("services.job_service.JobService.get_job")
    def test_prepare_retry_job_not_failed(self, mock_get):
    ...
    @patch("services.job_service.JobService.get_job")
    @patch("services.job_service.JobService.get_job_files")
    @patch("services.job_service.FileRepository")
    @patch("services.job_service.JobRepository")
    def test_delete_job_with_files(
        self, mock_job_repo_class, mock_file_repo_class, mock_get_files, mock_get_job
    ):
        ...
        with (
            ...
            mock_get_files.assert_called_once_with("job123")
    ...
    @patch("services.job_service.JobService.get_job")
    @patch("services.job_service.JobService.update_job")
    def test_cancel_job_success(self, mock_update, mock_get):
    ...
    @patch("services.job_service.JobService.get_job")
    def test_cancel_job_not_cancellable(self, mock_get):
